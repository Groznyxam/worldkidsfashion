...
// ── PRODUCT DATA ──────────────────────
const PRODUCTS = [
  { id:1,  name:'Organic Newborn Gift Set 5pcs', brand:'PureOrganic', cat:'newborn', price:24.90, moq:'Min. 3 sets',  emoji:'👶', bg:'pcard-img-bg1', badge:'gots',  sizes:['50','56','62'], colors:['White','Beige','Mint'] },
  { id:2,  name:'Baby Girl Floral Summer Dress', brand:'TurkishKids', cat:'baby',    price:8.50,  moq:'Min. 6 pcs',  emoji:'🌸', bg:'pcard-img-bg3', badge:'new',   sizes:['68','74','80','86'], colors:['Pink','White'] },
  { id:3,  name:'Boy Sport Tracksuit Set 2pcs',  brand:'ActiveKids',  cat:'boys',   price:15.90, moq:'Min. 6 pcs',  emoji:'⚽', bg:'pcard-img-bg2', badge:'hot',   sizes:['92','98','104','110','116'], colors:['Navy','Black','Red'] },
  { id:4,  name:'Girl Denim Jacket + Skirt Set', brand:'TurkishKids', cat:'girls',  price:22.90, moq:'Min. 4 pcs',  emoji:'👜', bg:'pcard-img-bg3', badge:'new',   sizes:['98','104','110','116','122'], colors:['Blue','Pink'] },
  { id:5,  name:'Baby Knit Romper Organic',       brand:'PureOrganic', cat:'baby',   price:11.90, moq:'Min. 6 pcs',  emoji:'🧶', bg:'pcard-img-bg1', badge:'gots',  sizes:['62','68','74','80'], colors:['Beige','Gray'] },
  { id:6,  name:'Boy Linen Summer Set 2pcs',      brand:'NaturalKids', cat:'boys',   price:13.50, moq:'Min. 6 pcs',  emoji:'🌿', bg:'pcard-img-bg4', badge:null,    sizes:['86','92','98','104'], colors:['Beige','White'] },
  { id:7,  name:'Girl Party Dress Tulle',          brand:'LittlePrincess',cat:'girls',price:18.90, moq:'Min. 4 pcs',  emoji:'✨', bg:'pcard-img-bg5', badge:'new',   sizes:['92','98','104','110','116'], colors:['Pink','Gold','White'] },
  { id:8,  name:'Boy Winter Puffer Jacket',        brand:'ActiveKids',  cat:'boys',  price:28.50, moq:'Min. 3 pcs',  emoji:'🧥', bg:'pcard-img-bg2', badge:null,    sizes:['104','110','116','122','128'], colors:['Navy','Black'] },
  { id:9,  name:'Newborn Hospital Outfit Set',     brand:'BabyCosy',    cat:'newborn',price:16.90,moq:'Min. 4 sets', emoji:'🏥', bg:'pcard-img-bg1', badge:'hot',   sizes:['50','56'], colors:['White','Mint','Pink'] },
  { id:10, name:'Baby Girl Tutu Dress',            brand:'LittlePrincess',cat:'baby', price:9.90, moq:'Min. 6 pcs',  emoji:'👗', bg:'pcard-img-bg3', badge:null,    sizes:['68','74','80','86'], colors:['Pink','Lilac'] },
  { id:11, name:'Unisex Muslin Swaddle 3pcs',      brand:'PureOrganic', cat:'newborn',price:19.50,moq:'Min. 5 sets', emoji:'🌙', bg:'pcard-img-bg4', badge:'gots',  sizes:['Universal'], colors:['White','Mint'] },
  { id:12, name:'Girl Embroidered Blouse',         brand:'TurkishKids', cat:'girls',  price:7.90, moq:'Min. 6 pcs',  emoji:'🎀', bg:'pcard-img-bg3', badge:'sale',  sizes:['98','104','110','116'], colors:['White','Powder'] },
  { id:13, name:'Boy Cargo Shorts + Tee Set',      brand:'ActiveKids',  cat:'boys',  price:12.50, moq:'Min. 6 pcs',  emoji:'🏄', bg:'pcard-img-bg6', badge:'sale',  sizes:['86','92','98','104','110'], colors:['Khaki','Navy'] },
  { id:14, name:'Newborn Organic Bodysuits 5pcs',  brand:'PureOrganic', cat:'newborn',price:21.90,moq:'Min. 3 sets', emoji:'🌱', bg:'pcard-img-bg4', badge:'gots',  sizes:['50','56','62'], colors:['White','Ecru'] },
  { id:15, name:'Baby Boy Dino Set 3pcs',          brand:'BabyCosy',    cat:'baby',   price:12.90, moq:'Min. 12 pcs',emoji:'🦕', bg:'pcard-img-bg1', badge:'new',   sizes:['62','68','74','80'], colors:['Blue','Gray'] },
  { id:16, name:'Girl Hoodie + Jogger Set',        brand:'TurkishKids', cat:'girls',  price:17.50, moq:'Min. 4 pcs', emoji:'🌈', bg:'pcard-img-bg5', badge:null,    sizes:['104','110','116','122','128'], colors:['Lilac','Pink'] },
];
